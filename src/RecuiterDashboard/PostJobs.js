      ...
      <div style={{marginTop:100}}>
        ...
        <Layout >
          <Content style={{ backgroundColor: '#eceff1', height: 696 }} >
            ...
            <Link style={{ color: 'white', background: '#01579b', borderRadius: 25, width: 150,paddingLeft:10, paddingRight:10, paddingTop:10,paddingBottom:10, height: 40, fontFamily: 'Quicksand', fontSize: 20, position:'absolute', left:650, top:620 }} to='/recruiter-dashboard/Managejobs'>Post Job</Link>
